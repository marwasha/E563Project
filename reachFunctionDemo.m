...
X0.init = [-.4691; -0.1236; 0.3455; 0; 0; 0];
X0.dist = [0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000];
P0.init = [0.5000; 1.0000; 1.2000; 0.0000; 0.0000; 0.0000];
P0.dist = [0.0005, 0.0010, 0.0010, 0.0000, 0.0000, 0.0000]*0;

U0.fault.init = [-0.5; 0.4; -0.3; 1.0; 1.0; 1.0];
U0.fault.dist = [ 0.0000, 0.4000, 0.0000, 0.0000, 0.0000, 0.0000];
param.fault.tFinal = 0.001;
param.fault.steps = 20;

U0.post.init = [-0.5; 0.8; -0.3; 1.0; 1.0; 1.0];
U0.post.dist = [0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000];
param.post.tFinal = 20;
param.post.steps = 200;
