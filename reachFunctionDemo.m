...
X0.init = [-.4691; -.1236; 0.3455; 0.0000; 0.0000; 0.0000];
X0.dist = [2.5000, 0.2200, 2.4000, 0.0000, 0.0000, 0.0000]/10;
P0.init = [0.5000; 1.0000; 1.2000; 0.1000; 0.1000; 0.1000];
P0.dist = [0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000];

U0.fault.init = [-0.5; 0.8; -0.3; 1.0; 1.0; 1.0];
U0.fault.dist = [ 0.0000, 0.000, 0.0000, 0.0000, 0.0000, 0.0000];
param.fault.tFinal = .0000000001;
